...
-- TAO DU LIEU
--NHANVIEN----------------------
EXEC SP_INS_PUBLIC_NHANVIEN 'NV01', N'NGUYEN VAN A', 'NVA@', 3000000, 'NV01', 'PASS12'
EXEC SP_INS_PUBLIC_NHANVIEN 'NV02', N'NGUYEN VAN B', 'NVB@', 5000000, 'NV02', 'PASS34'
EXEC SP_INS_PUBLIC_NHANVIEN 'NV03', N'NGUYEN VAN C', 'NVC@', 7500000, 'NV03', 'PASS56'

SELECT* FROM NHANVIEN
--XEM NHANVIEN CHUA MA HOA (NV01)
exec SP_SEL_PUBLIC_NHANVIEN 'NV01', 'PASS12'
GO
