...
GO
-- PROCEDURE LẤY TOÀN BỘ SINH VIÊN CỦA LỚP THUỘC QUẢN LÝ CỦA NGƯỜI ĐANG ĐĂNG NHẬP
CREATE PROC SP_UV_SV_LOP @MANV VARCHAR(20)
AS
	SELECT SV.MASV, SV.HOTEN, SV.NGAYSINH, SV.DIACHI
	FROM LOP, SINHVIEN SV
	WHERE LOP.MANV = @MANV AND SV.MALOP = LOP.MALOP
GO
EXEC SP_UV_SV_LOP 'NV01'
GO
